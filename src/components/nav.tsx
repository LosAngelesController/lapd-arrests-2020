...
const navigation: any = [
  ...
  {
    name: "2022",
    href: "https://2022arrests.lacontroller.app/",
    target: "_blank",
  },
  {
    name: "41.18",
  ...
  {
    name: "Table",
    href: "https://docs.google.com/spreadsheets/d/1kYoUKNuNRjjfSrE53GxYbTyLxk0_qJM7L6JXgcSwV5w/edit?usp=sharing",
    target: "_blank",
  },
  {
    name: "Analysis",
            ...
            <div className="">
              ...
              <div className="flex flex-row sm:hidden">
                ...
                <div className="grid content-center ml-2">
                  <strong className="text-white">LAPD Arrests 2020</strong>
                </div>
              </div>
